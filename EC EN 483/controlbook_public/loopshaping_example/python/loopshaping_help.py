...
if __name__=="__main__":
    ...
    # 
    #   We want:
    #       - Track a ramp input so error is within 10% of ramp amplitude
    #       - Attenuate noise signals with frequency content above omega_n = 10 rad/s to 10% of noise amplitude
    #       - Reduce input disturbance effects to 10% of disturbance amplitude
    #
    # ls.spec_track_ramp(gamma_r=0.1)
